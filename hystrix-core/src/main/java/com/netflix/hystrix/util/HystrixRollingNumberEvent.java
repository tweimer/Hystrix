...
public enum HystrixRollingNumberEvent {
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        return switch (eventType) {
            case BAD_REQUEST -> HystrixRollingNumberEvent.BAD_REQUEST;
            case COLLAPSED -> HystrixRollingNumberEvent.COLLAPSED;
            case EMIT -> HystrixRollingNumberEvent.EMIT;
            case EXCEPTION_THROWN -> HystrixRollingNumberEvent.EXCEPTION_THROWN;
            case FAILURE -> HystrixRollingNumberEvent.FAILURE;
            case FALLBACK_EMIT -> HystrixRollingNumberEvent.FALLBACK_EMIT;
            case FALLBACK_FAILURE -> HystrixRollingNumberEvent.FALLBACK_FAILURE;
            case FALLBACK_DISABLED -> HystrixRollingNumberEvent.FALLBACK_DISABLED;
            case FALLBACK_MISSING -> HystrixRollingNumberEvent.FALLBACK_MISSING;
            case FALLBACK_REJECTION -> HystrixRollingNumberEvent.FALLBACK_REJECTION;
            case FALLBACK_SUCCESS -> HystrixRollingNumberEvent.FALLBACK_SUCCESS;
            case RESPONSE_FROM_CACHE -> HystrixRollingNumberEvent.RESPONSE_FROM_CACHE;
            case SEMAPHORE_REJECTED -> HystrixRollingNumberEvent.SEMAPHORE_REJECTED;
            case SHORT_CIRCUITED -> HystrixRollingNumberEvent.SHORT_CIRCUITED;
            case SUCCESS -> HystrixRollingNumberEvent.SUCCESS;
            case THREAD_POOL_REJECTED -> HystrixRollingNumberEvent.THREAD_POOL_REJECTED;
            case TIMEOUT -> HystrixRollingNumberEvent.TIMEOUT;
