...
public class HystrixMetricsPublisherFactoryTest {
    ...
    private enum TestCommandKey implements HystrixCommandKey { TEST_A, TEST_B }

    private enum TestThreadPoolKey implements HystrixThreadPoolKey { TEST_A, TEST_B }

    static class CustomPublisher extends HystrixMetricsPublisher{
        private final HystrixMetricsPublisherCommand commandToReturn;
