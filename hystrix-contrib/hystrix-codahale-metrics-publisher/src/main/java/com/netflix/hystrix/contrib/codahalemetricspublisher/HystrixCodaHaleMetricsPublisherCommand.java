...
public class HystrixCodaHaleMetricsPublisherCommand implements HystrixMetricsPublisherCommand {
    ...
    public void initialize() {
        ...
        safelyCreateCumulativeCountForEvent("countFallbackDisabled", () -> HystrixRollingNumberEvent.FALLBACK_DISABLED);
        ...
        safelyCreateRollingCountForEvent("rollingCountFallbackDisabled", () -> HystrixRollingNumberEvent.FALLBACK_DISABLED);
        ...
        safelyCreateRollingCountForEvent("rollingMaxConcurrentExecutionCount", () -> HystrixRollingNumberEvent.COMMAND_MAX_ACTIVE);
