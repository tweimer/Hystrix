...
public class HystrixCodaHaleMetricsPublisherThreadPool implements HystrixMetricsPublisherThreadPool {
    ...
    public void initialize() {
        ...
        metricRegistry.register(createMetricName("propertyValue_maximumSize"), (Gauge<Number>) properties.maximumSize()::get);
        metricRegistry.register(createMetricName("propertyValue_actualMaximumSize"), (Gauge<Number>) properties::actualMaximumSize);
